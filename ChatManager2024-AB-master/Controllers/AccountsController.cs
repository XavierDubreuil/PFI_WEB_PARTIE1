...
namespace ChatManager.Controllers
{
    public class AccountsController : Controller
    {
        ...
        [OnlineUsers.AdminAccess] // RefreshTimout = false otherwise periodical refresh with lead to never timed out session
        ...
        {
            return Json(OnlineUsers.CurrentUserHasNotifications(), JsonRequestBehavior.AllowGet);
        }
        public JsonResult GetUserNotifications()
        {
            var notifications = OnlineUsers.PopLastNotifications();
